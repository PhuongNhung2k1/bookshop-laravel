                               ...
                               <td><span class="status-p bg-success">{{$rows->quantity}}</span></td>
                                <td>
                                    <ul class="d-flex justify-content-center">
                                        ...
                                        <li><a href="" class="text-danger" data-toggle="modal" data-target="#exampleModal"><i class="ti-trash"></i></a></li>
                                    </ul>
                                </td>
                            </tr>
                            @endforeach
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a href="{{url('backend/products/delete/'.$rows->id)}}"><button  type="button"  class="btn btn-primary">Xoá</button></a>
        </div>
      </div>
    </div>
  </div>
